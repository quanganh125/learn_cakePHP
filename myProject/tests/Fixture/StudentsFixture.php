...
class StudentsFixture extends TestFixture
{
    ...
    // phpcs:disable
    public $fields = [
        'idstudent' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'country' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => '2020-08-17 07:12:22',
                'updated_at' => '2020-08-17 07:12:22',
            ],
        ];
        parent::init();
    }
