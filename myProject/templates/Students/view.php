...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Student'), ['action' => 'edit', $student->idstudent], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Student'), ['action' => 'delete', $student->idstudent], ['confirm' => __('Are you sure you want to delete # {0}?', $student->idstudent), 'class' => 'side-nav-item']) ?>
